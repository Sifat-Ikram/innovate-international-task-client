...
const SignUpSection = () => {
  return (
    <div className="flex max-md:flex-col justify-center items-center gap-20 w-11/12 mx-auto my-56">
      <div className="w-3/5 h-[600px] flex max-md:flex-col justify-center items-center gap-20">
        <div className="flex flex-col gap-10 md:gap-20">
          <div className="relative">
            <div className="shadow flex justify-center items-center h-[295px] w-[285px] rounded-3xl">
              <div className="h-[285px] w-[275px] items-center flex rounded-3xl bg-gradient-to-tr from-[#1300EE] to-[#1A0EA4] px-8">
                <h1 className="text-4xl font-medium text-white">Photo 1</h1>
              </div>
            </div>
            <div className="shadow h-20 w-20 rounded-full p-1 left-60 top-60 absolute">
              <Image
                src="/Ellipse 1.png"
                alt="Img-1"
                width={80}
